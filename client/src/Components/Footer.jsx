			...
			{DoNotRenderFooter() ? null : (
				<footer className="footer">
					<div className="footer__follow-us">
						<p>Follow us on</p>
						<a href="https://www.facebook.com/HooHoopNZ/" target="_blank" className="footer__logo">
							<img src={Facebook} height={"12rem"} />
						</a>
						<a href="https://www.linkedin.com/company/hoohoop-limited-nz" target="_blank" className="footer__logo">
							<img src={LinkedIn} height={"12rem"} />
						</a>
						<a href="https://instagram.com/hoohoopnz?igshid=43art0hn3v5n" target="_blank" className="footer__logo">
