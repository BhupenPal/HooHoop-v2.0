			...
			<div className={classes.boxContainer}>
				...
				<div style={{ position: "relative" }}>
					...
					>
						...
						<Box mt={5}>
							<div
								className={`${classes.options} ${user.CallbackQuery ? classes.checked : ""
									}`}
							>
								<input
									type="checkbox"
							...
							<div
								className={`${classes.options} ${user.TestDriveQuery ? classes.checked : ""
									}`}
							>
								<input
									type="checkbox"
							...
							<div
								className={`${classes.options} ${user.ShipmentQuery ? classes.checked : ""
									}`}
							>
								<input
									type="checkbox"
